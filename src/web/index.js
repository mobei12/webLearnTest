...
function nameFormat(array, callback) {
	//判断是否为函数
	if (Object.prototype.toString.call(callback).slice(8, -1).toLowerCase() !== 'function') {
		throw new Error(
...
const a = ['0.1.1', '0.302.1', '2.3.3', '4.2', '4.3.4.5', '4.3.5']
const res = nameFormat(a, function (item) {
	return item + '-'
})
console.log(res)
